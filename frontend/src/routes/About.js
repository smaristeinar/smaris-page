                ...
                <div className="flex flex-col gap-5">
                    ...
                    <ul className="pl-2">
                        <li className="pb-3">
                            ...
                            <p className="text-lg pl-2">For 26 weeks I worked with a Coolstuff as a frontend/fullstack dev getting to experience daily life as a professional dev. Working in a agile team developing features and solving problems in a Svelte-kit frontend with a headless CMS that talks GraphQL  and served from GCP</p>
                        </li>
                    </ul>
                </div>
            </div>
